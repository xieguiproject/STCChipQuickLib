...
#line 1 "Src\bspKeyScanf.c" /0
  
#line 1 "Src\bspKeyScanf.h" /0
...
#line 1 "Src\bspKeyScanf.c" /0
 ...
 GPIO_InitStruct.GPIO_Pin = 0x10 | 0x40;
 GPIO_InitStruct.GPIO_Mode = GPIO_Mode_Standard_IO;
 
 GPIO_Init(0x04,&GPIO_InitStruct);
 
 GPIO_InitStruct.GPIO_Pin = 0x10 | 0x20;
 GPIO_InitStruct.GPIO_Mode = GPIO_Mode_Standard_IO;
 
 GPIO_Init(0x05,&GPIO_InitStruct);
