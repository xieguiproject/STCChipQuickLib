...
#line 1 "Libraries\STC15_StdPeriph_Driver\src\stc15xx_gpio.c" /0
...
#line 1 "Libraries\STC15_StdPeriph_Driver\src\stc15xx_gpio.c" /0
 ...
 status GPIO_Init(uint8_t GPIO_PX,GPIO_InitTypeDef *GPIO_InitStruct)
 {
 if(GPIO_PX > 0x05)				return -1;	 
 if(GPIO_InitStruct->GPIO_Mode > GPIO_Mode_Out_PP)	return -1;	 
 if(GPIO_PX == 0X00)
 {
 if(GPIO_InitStruct->GPIO_Mode == GPIO_Mode_Standard_IO)
 {
 P0M1 &= ~GPIO_InitStruct->GPIO_Pin;
 P0M0 &= ~GPIO_InitStruct->GPIO_Pin;	  
 }
